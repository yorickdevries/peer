            ...
            <b-row>
                <b-col>
                    ...
                    <template v-if="assignment.enrollable">
                        <dt>Import groups</dt>
                        <dd>
                            Not available. On creation of the assignment, this assignment has been set as
                            self-enrollable.
                        </dd>
                    </template>
                    <template v-else>
...
added back to a new or pre-existing group."
                ...
                <template v-slot:row-details="row">
                    ...
                    <b-card header="Submissions" class="h-100">
                            ...
                            >
                                ...
                                <template v-slot:cell(action)="data">
                                    ...
                                    <b-button
                                        ...
                                        :disabled="
                                            !(
                                                assignment.state === 'submission' ||
                                                assignment.state === 'waitingforreview'
                                            )
                                        "
                                        size="sm"
                                        variant="secondary"
                        ...
                        >
                            ...
                            />
                            <b-button variant="primary" class="mt-3" @click="submitSubmission(row.item)"
                                >Upload</b-button
                            >
                        </b-modal>
                    </b-card>
        ...
        <div v-else>
            <b-alert show variant="danger">You cannot modify groups after submission state has passed.</b-alert>
        </div>
    </div>
</template>
