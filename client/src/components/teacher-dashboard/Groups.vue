                            ...
                            <b-row>
                                <b-col>
                                    <dl>
                                        ...
                                        <dd v-for="member in row.item.members" :key="member.user_netid" class="d-flex mb-2 align-middle">
                                            <b-button variant="danger" size="sm" @click="removeGroupMember(row.item.id, member.user_netid)">Remove</b-button>
                                        ...
                                        <dd class="d-flex">
                                            <b-button variant="success" class="mr-2" size="sm" @click="addGroupMember(row.item.id, netNetId)">Add Group Member</b-button>
