<template>
    <div>
        <b-form-group
            ...
            description="The question number. These questions will appear in this order (sorted)."
        >
                ...
                <b-form :key="index">
                    <div class="input-group mb-2">
                        ...
                        <div class="input-group-append">
                            <b-button
                                @click="deleteCheckboxOption(question, option)"
                                v-if="!option.delete"
                                variant="danger"
                                size="sm"
                                >Delete
                            </b-button>
                            <b-button @click="undoDeleteCheckboxOption(option)" v-else variant="secondary" size="sm"
                                >Undo
                            </b-button>
                        </div>
                    </div>
    ...
    methods: {
        addCheckboxOption(question) {
            question.options.push({
                text: "",
                checkboxQuestionId: question.id
            })
        },
