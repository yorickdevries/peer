                ...
                <b-card class="shadow py-2">
                    <b-row>
                        <b-col>
                            ...
                            <p>The Peer project is a project from the TU Delft. In this privacy statement, it will be explained what personal data Peer collects when using the website.
                            </p>
                            ...
                            <p>In the future, this data might be used for research purposes. This research would be done to explore the possibilities of increasing efficiency and quality of the support given to students and teachers. When that happens and if this falls within your rights, you will be able to opt out of this.</p>

                            <h2>How do we store your data</h2>
                            <p>To comply with GDPR regulations, all data is stored on site at the TU Delft. Currently, the data stored has no expiration date (date where it will be deleted).</p>

                            <h2>Marketing</h2>
                            <p>We will not use Peer data for marketing purposes.</p>

                            <h2>What are your data protection rights?</h2>
                            <p>The TU Delft would like to make sure you are fully aware of all of your data protection rights. Every user is entitled to the following:</p>
                            <p><b>The right to access</b> – You have the right to request the TU Delft for copies of your personal data. We may charge you a small fee for this service.</p>
                            <p><b>The right to rectification</b> – You have the right to request that the TU Delft correct any information you believe is inaccurate. You also have the right to request the TU Delft to complete the information you believe is incomplete.</p>
                            <p><b>The right to erasure</b> – You have the right to request that the TU Delft erase your personal data, under certain conditions.</p>
                            ...
                            <ul>
                                <li>not be allowed, as we need this data to fulfill your request to be a student and gave us permission to do so</li>
                                <li>be allowed, but will result in failing the corresponding course</li>
                                <li>be allowed, but will forfeit your ability to dispute the grade for the course you followed</li>
                            </ul>

                            <p>There is a current investigation into this question and once this has concluded, the privacy statement will be updated to reflect the conclusions.</p>
                            ...
                            <p>The the TU Delft website contains links to other websites. Our privacy policy applies only to our website, so if you click on a link to another website, you should read their privacy policy.</p>
                            ...
                            <p>Should you wish to report a complaint or if you feel that the TU Delft has not addressed your concern in a satisfactory manner, you may contact the Information Commissioner’s Office.</p>
                        </b-col>
                    </b-row>
                </b-card>
            </b-container>
