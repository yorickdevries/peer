...
const templateQuestionsGraded: QuestionTemplate[] = [
  ...
  },
  {
    ...
    type: QuestionType.MULTIPLE_CHOICE,
    options: [
      { text: "A: Yes, fully", points: 1 },
      { text: "B: Yes, mostly", points: 0.7 },
      { text: "C: No, mostly not", points: 0.3 },
      { text: "D: No, not at all", points: 0.0 },
    ],
    graded: true,
  },
  {
    ...
    type: QuestionType.MULTIPLE_CHOICE,
    options: [
      { text: "A: Yes, major mistakes", points: 0.0 },
      { text: "B: Yes, minor mistakes", points: 0.5 },
      { text: "C: No", points: 1 },
    ],
    graded: true,
  },
  ...
  },
  {
    ...
    type: QuestionType.MULTIPLE_CHOICE,
    options: [
      { text: "A: Too little", points: 0.3 },
      { text: "B: An acceptable amount", points: 0.7 },
      { text: "C: Much", points: 1 },
      { text: "D: Not applicable", points: 0.0 },
    ],
    graded: true,
  },
  {
    ...
    options: [
      { text: "A: Yes", points: 1 },
      { text: "B: No", points: 0.0 },
      { text: "C: Not applicable", points: 0.0 },
    ],
    graded: true,
  },
  {
