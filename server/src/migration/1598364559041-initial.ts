...
export class initial1598364559041 implements MigrationInterface {
    name = 'initial1598364559041'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `affiliation` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `name` varchar(191) NOT NULL, PRIMARY KEY (`name`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `study` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `name` varchar(191) NOT NULL, PRIMARY KEY (`name`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `organisation_unit` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `name` varchar(191) NOT NULL, PRIMARY KEY (`name`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `netid` varchar(191) NOT NULL, `studentNumber` int NULL, `firstName` varchar(255) NULL, `prefix` varchar(255) NULL, `lastName` varchar(255) NULL, `email` varchar(255) NULL, `displayName` varchar(255) NULL, PRIMARY KEY (`netid`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `faculty` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `name` varchar(191) NOT NULL, `longName` varchar(255) NOT NULL, PRIMARY KEY (`name`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `academic_year` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `name` varchar(191) NOT NULL, `active` tinyint NOT NULL, PRIMARY KEY (`name`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `review` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `type` varchar(255) NOT NULL, `flaggedByReviewer` tinyint NOT NULL, `submitted` tinyint NOT NULL, `startedAt` timestamp NULL, `downloadedAt` timestamp NULL, `submittedAt` timestamp NULL, `approvalByTA` tinyint NULL, `questionnaireId` int NOT NULL, `reviewerNetid` varchar(191) NOT NULL, `approvingTANetid` varchar(191) NULL, `reviewOfSubmissionId` int NULL, `submissionId` int NULL, INDEX `IDX_8edcfd5ea728371ad7debd6996` (`type`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `submission` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `userNetid` varchar(191) NOT NULL, `groupId` int NOT NULL, `assignmentId` int NOT NULL, `fileId` int NULL, UNIQUE INDEX `REL_dec51148a6379ffdc1ea98fdb8` (`fileId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `submission_comment` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `text` text NOT NULL, `userNetid` varchar(191) NOT NULL, `submissionId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `review_comment` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `text` text NOT NULL, `userNetid` varchar(191) NOT NULL, `reviewId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user_affiliation_affiliation` (`userNetid` varchar(191) NOT NULL, `affiliationName` varchar(191) NOT NULL, INDEX `IDX_c16e312cfa5a5519f335c4b637` (`userNetid`), INDEX `IDX_4bc14ec09a7bb01fdb2d6baf57` (`affiliationName`), PRIMARY KEY (`userNetid`, `affiliationName`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user_study_study` (`userNetid` varchar(191) NOT NULL, `studyName` varchar(191) NOT NULL, INDEX `IDX_7b982e7b1038174bc289e8e4c1` (`userNetid`), INDEX `IDX_9341633db9bbfae9e1475285f8` (`studyName`), PRIMARY KEY (`userNetid`, `studyName`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user_organisation_unit_organisation_unit` (`userNetid` varchar(191) NOT NULL, `organisationUnitName` varchar(191) NOT NULL, INDEX `IDX_7c86819087c1b50c998f76d96c` (`userNetid`), INDEX `IDX_e6f2d6704a46d4133648f2933e` (`organisationUnitName`), PRIMARY KEY (`userNetid`, `organisationUnitName`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `group_users_user` (`groupId` int NOT NULL, `userNetid` varchar(191) NOT NULL, INDEX `IDX_fe6cce7d479552c17823e267af` (`groupId`), INDEX `IDX_c180b6dbe5df75d65af330f95b` (`userNetid`), PRIMARY KEY (`groupId`, `userNetid`)) ENGINE=InnoDB");
