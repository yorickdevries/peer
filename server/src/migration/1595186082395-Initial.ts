...
export class Initial1595186082395 implements MigrationInterface {
    name = 'Initial1595186082395'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `review` (`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `type` varchar(255) NOT NULL, `flaggedByReviewer` tinyint NOT NULL, `submitted` tinyint NOT NULL, `startedAt` timestamp NULL, `downloadedAt` timestamp NULL, `savedAt` timestamp NULL, `submittedAt` timestamp NULL, `approvalByTA` tinyint NULL, `questionnaireId` int NOT NULL, `reviewerNetid` varchar(255) NOT NULL, `approvingTANetid` varchar(255) NULL, `reviewOfSubmissionId` int NULL, `submissionId` int NULL, INDEX `IDX_8edcfd5ea728371ad7debd6996` (`type`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
