...
describe("API Assignment routes", () => {
    ...
    it("Reviews export valid", async () => {
        ...
        expect(gradeExport.text.includes("\"Submitter netid\",\"Submitter studentnumber\",\"Submitter group id\",\"Submitter group name\",\"Reviewer netid\",\"Reviewer studentnumber\",\"Reviewer group id\",\"Reviewer group name\""
        )).to.equal(true);
