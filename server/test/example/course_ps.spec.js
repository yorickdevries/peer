...
var courses_ps_1 = require("../../src/prepared_statements/courses_ps");
...
describe("CoursePreparedStatement Test", function () {
    /**
     ...
     * Get all courses
     */
    it("get all courses", function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
    ...
    it("get assignment by course id", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = chai_1.expect;
                    return [4 /*yield*/, courses_ps_1.default.executeGetAssignmentsByCourseId(1)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.deep.equal([{
                            course_id: 1,
 ...
 */
     ...
     */
    it("get all enrolled courses", function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, courses_ps_1.default.executeGetAllEnrolledCourses('paulvanderlaan')];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
     ...
     */
    it("get course role of user", function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, courses_ps_1.default.executeGetRoleById('paulvanderlaan', 1)];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
