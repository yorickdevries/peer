    ...
    it("get assignments by course id and assignment id", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = chai_1.expect;
                    return [4 /*yield*/, assignment_ps_1.default.executeGetAssignmentById(1, 1)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.deep.equal([{
                            title: "Assignment 1",
                            description: "Example assignment number one",
    ...
    it("add assignment", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = chai_1.expect;
                    return [4 /*yield*/, assignment_ps_1.default.executeAddAssignment("New", "Description")];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.deep.equal([{
                            course_id: 1,
    ...
    it("update assignment", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = chai_1.expect;
                    return [4 /*yield*/, assignment_ps_1.default.executeUpdateAssignmentById("Updated", "updated", 1, 1)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.deep.equal([{
                            course_id: 1,
                            description: "updated",
