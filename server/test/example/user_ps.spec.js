...
var user_ps_1 = require("../../src/prepared_statements/user_ps");
...
describe("UserPreparedStatements Test", function () {
    /**
     ...
     */
    it("get user by id", function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = chai_1.expect;
                    return [4 /*yield*/, user_ps_1.default.executeGetUserById("paulvanderlaan")];
                case 1:
